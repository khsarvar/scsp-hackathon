...
async def upload_csv(file: UploadFile = File(...)):
    ...
    # Seed the multi-frame workspace so downstream agent loops can address
    # the upload by alias ('main') alongside any later joined frames.
    sess.workspace.add("main", df, {"source": f"upload:{file.filename}"})
